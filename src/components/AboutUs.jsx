...
const AboutUs = () => {
   ...
   return (
      <>
      <div className="max-w-4xl mx-auto px-5 mt-10 mb-10">

<div className="text-center">
    <h2 className="font-semibold text-4xl font-style: italic">About Us</h2>
    <p className="max-w-md mx-auto mt-2 text-gray-500">Features you will love to be seen</p>
</div>
...
<div className="grid md:grid-cols-2 gap-10 mt-10">
    ...
    <div className="flex gap-4 items-start">
        ...
        <div>
            <h3 className="font-semibold text-xl font-style: italic">Customizable</h3>
            <p className="mt-1 text-gray-500"> You do not need to be an expert to customize this plugin. Our code is very
    ...
    <div className="flex gap-4 items-start">
        ...
        <div>
            <h3 className="font-semibold text-xl font-style: italic">Fully Responsive</h3>
            <p className="mt-1 text-gray-500"> With mobile, tablet &amp; desktop support it do not matter what device
                you are using. This plugin is responsive in all browsers. </p>
        </div>
    </div>
    ...
    <div className="flex gap-4 items-start">
        ...
        <div>
            <h3 className="font-semibold text-xl font-style: italic">Developer Support</h3>
    ...
    <div className="flex gap-4 items-start">
        ...
        <div>
            <h3 className="font-semibold text-xl font-style: italic">Cross Browser</h3>
    ...
    <div className="flex gap-4 items-start">
        ...
        <div>
            <h3 className="font-semibold text-xl font-style: italic">Clean Code</h3>
    ...
    <div className="flex gap-4 items-start">
        ...
        <div>
            <h3 className="font-semibold text-xl font-style: italic">Well Maintained</h3>
